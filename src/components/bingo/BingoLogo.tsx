...
const TILES = [
  { letter: "B", bg: "linear-gradient(to bottom, #ffe066 0%, #f5c542 45%, #c49200 100%)", shadow: "#8a6600", text: "#111" },
  { letter: "I", bg: "linear-gradient(to bottom, #ff7070 0%, #e84040 45%, #991a1a 100%)", shadow: "#660000", text: "#fff" },
  { letter: "N", bg: "linear-gradient(to bottom, #7dd4ff 0%, #4db8ff 45%, #1a80cc 100%)", shadow: "#004d99", text: "#111" },
